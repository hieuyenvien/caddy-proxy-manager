#!/bin/bash
# ====================================================
# Keepalived notify script — VM2 (nginxlove2 - 10.2.159.19)
# PEER = VM1 (10.2.159.18)
#
...
# của Web UI (INSTANCE_MODE=slave, nhận từ master qua REST API).
# Script này chỉ reload Caddy khi node nhận VIP (để áp dụng
# config mới nhất đã được đồng bộ trước đó).
# ====================================================
...
case "$STATE" in
    ...
    MASTER)
        ...
        # Config đã được đồng bộ liên tục từ VM1 qua REST API
